...
BOT_TOKEN = getenv("BOT_TOKEN", "5462640240:AAH-ZLSQ_ftMVTX43wES4eI7qnYV8IeObMo")
BOT_NAME = getenv("BOT_NAME", "Hshsgs")
...
BOT_USERNAME = getenv("BOT_USERNAME", "RANI_1bot")
OWNER_ID = getenv("OWNER_ID", "2123424524")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "RANI")
